...
export const SimpleChart = ({ data }: { data: MergedDataPoint[] }) => {
  ...
  const [mainSeries, setMainSeries] = useState<am5xy.LineSeries | null>(null);
  ...
  useEffect(() => {
    ...
    mainSeries.fills.template.setAll({ fillGradient: gradient, visible: true });
